...
var userAdditionComponent = function userAdditionComponent(props) {
  ...
  var officeId = props.officeId;
  var singleChip = props.singleChip;
  var menuEl = input.parentNode.nextElementSibling;
  var menu = new mdc.menu.MDCMenu(menuEl);
  var chipSetEl = menuEl.nextElementSibling;
...
var createUserChip = function createUserChip(user) {
